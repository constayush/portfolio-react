...
function Contact() {
    return (
        ...
        //     <div className=' conH1 conChild ml-[2rem] text-[3.4rem] md:text-[5rem]  h-[89vh] flex justify-center items-center'>
        //         <h1 >
        ...
        //         </h1>
        //     </div>
        //     <div className=' conChild mx-[7rem] h-[80vh] flex flex-col justify-start items-left text-left w-[80%] md:w-[60%] text-[1.125rem]'>
